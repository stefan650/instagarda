        ...
        <div class="ig-map-explorer">
            ...
            <div class="ig-map-explorer__map">
                <div class="ig-svg-map ig-svg-map--transparent">
                    ...
                    $pin_positions = [
                        'sirmione'            => ['33%', '26%'],
                        'desenzano-del-garda' => ['13%', '23%'],
                        'salo'                => ['10%', '49%'],
                        'gardone-riviera'     => ['41%', '62%'],
                        'toscolano-maderno'   => ['30%', '52%'],
                        'gargnano'            => ['50%', '68%'],
                        'limone-sul-garda'    => ['71%', '83%'],
                        ...
                        'nago-torbole'        => ['90%', '88%'],
                        'arco'                => ['90%', '97%'],
                        'manerba-del-garda'   => ['22%', '38%'],
                        'padenghe-sul-garda'  => ['6%', '30%'],
                        'soiano-del-lago'       => ['5%', '38%'],
                        'polpenazze-del-garda'  => ['3%', '44%'],
                        'moniga-del-garda'      => ['17%', '32%'],
                        'san-felice-del-benaco' => ['17%', '44%'],
                        'lonato-del-garda'      => ['5%', '16%'],
                        'castelnuovo-del-garda' => ['70%', '21%'],
                        'valeggio-sul-mincio'   => ['55%', '9%'],
                    ];
                    ...
                    $citta_ref = [
                        ...
                        'Mantova'  => ['55%', '-3%', '/destinazioni/mantova/', 'Gioiello rinascimentale dei Gonzaga, città d\'acqua e d\'arte patrimonio UNESCO a sud del lago.', 'mantova.jpg'],
                    ];
